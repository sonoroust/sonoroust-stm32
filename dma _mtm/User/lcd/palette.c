...
void Draw_Clear_Button(void *btn);
void Draw_Shape_Button(void *btn);

void Command_Select_Color(void *btn);
void Command_Select_Brush(void *btn);
void Command_Clear_Palette(void *btn);
